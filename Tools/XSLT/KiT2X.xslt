...
<stylesheet
	...
	xmlns:style="tag:go.KIBI.family,2020:XSLT::Style"
...
*.tei.preserve::before,*.tei.preserve::after{ Content: "\2060" }
					<for-each select="document('')//style:css">
						<value-of select="text()"/>
					</for-each>
				</html:style>
	...
	<template match="tei:teiHeader">
		...
		<style:css>
			*.tei.teiHeader{ Display: Flow-Root; Position: Relative; Margin-Block: 0 .5EM; Border-Block: Thin Var(--GreyText) Solid; Padding-Block: .5EM; Padding-Inline: 3EM; Line-Height: 1 }
	...
	<template match="tei:lg">
		...
		<style:css>
			...
			*.tei.lg[data--t-e-i_n]::before{ Position: Absolute; Inset-Block-Start: 0; Inset-Inline-End: 100%; Margin-Inline: 0 .75EM; Min-Inline-Size: 2.5EM; Color: Var(--GreyText); Font-Variant-Numeric: Tabular-Nums Lining-Nums; Text-Align: End; Text-Align-Last: Auto; Text-Indent: 0; White-Space: Pre; Content: "¶" Attr(data--t-e-i_n) }
	...
	<template match="tei:stage">
		...
		<style:css>
			...
			*.tei.stage[data--t-e-i_type~=exit]{ Display: Block; Margin-Block: 1EM; Font-Variant-Caps: Small-Caps; Line-Height: 1; Text-Align: Justify; Text-Align-Last: End }
			*.tei.stage[data--t-e-i_type~=entrance]{ Display: Block; Margin-Block: 1EM; Font-Variant-Caps: Small-Caps; Line-Height: 1; Text-Align: Justify; Text-Align-Last: Start }
			*.tei.stage[data--t-e-i_type~=setting]{ Display: Block; Margin-Block: 1EM; Font-Weight: Bolder; Font-Variant-Caps: Normal; Line-Height: 1; Text-Align: Start; Text-Align-Last: Auto; Text-Transform: Uppercase }
			*.tei.stage[data--t-e-i_type~=novelistic]{ Display: Block; Margin-Block: 1.5EM; Font-Variant-Caps: Normal; Text-Align: Inherit; Text-Align-Last: Inherit }
			<fallback/>
		</style:css>
	</template>
	...
	<template match="tei:hi|tei:foreign|tei:mentioned|tei:soCalled">
		...
		<style:css>
			*.tei.hi{ Display: Inline; Font-Style: Inherit; Text-Decoration: Var(--EditorialText) Wavy Underline }
	...
	<template match="tei:title">
		...
		<style:css>
			...
			*.tei.title[data--t-e-i_level=j]{ Font-Variant-Caps: Petite-Caps; Text-Decoration: Underline }
			*.tei.title[data--t-e-i_level=m]{ Text-Decoration: Underline }
			*.tei.title[data--t-e-i_level=s]{ Font-Variant-Caps: Petite-Caps }
			*.tei.title[data--t-e-i_level=a]::before,*.tei.title[data--t-e-i_level=u]::before{ Font-Variant-Caps: Normal; Content: "“" }
			*.tei.title[data--t-e-i_level=a]::after,*.tei.title[data--t-e-i_level=u]::after{ Font-Variant-Caps: Normal; Content: "”" }
			<fallback/>
		</style:css>
	</template>
	<template match="tei:q">
		...
		<style:css>
			...
			*.tei.q[data--t-e-i_type=foreign]::after{ Font-Variant-Caps: Normal; Content: "⸣" }
			*.tei.q[data--t-e-i_type=mentioned]::before{ Font-Variant-Caps: Normal; Content: "‘" }
			*.tei.q[data--t-e-i_type=mentioned]::after{ Font-Variant-Caps: Normal; Content: "’" }
	...
	<template match="tei:ref">
		...
		<style:css>
			*.tei.ref{ Display: Inline; Color: Var(--EditorialText); Text-Decoration: Dashed Underline }
			<fallback/>
		</style:css>
	</template>
	...
	<template match="tei:corr|tei:reg">
		...
		<style:css>
			*.tei.corr,*.tei.reg{ Display: Inline; Text-Decoration: Var(--EditText) Underline; Text-Decoration-Skip-Ink: None }
			*.tei.corr[data--t-e-i_evidence=conjecture],*.tei.reg[data--t-e-i_evidence=conjecture]{ Text-Decoration-Style: Dashed }
			<fallback/>
		</style:css>
	</template>
	<template match="tei:sic|tei:orig">
		...
		<style:css>
			*.tei.sic,*.tei.orig{ Display: Inline; Text-Decoration: Var(--EditText) Wavy Underline; Text-Decoration-Skip-Ink: None }
			<fallback/>
		</style:css>
	</template>
	<template match="tei:choice">
		...
		<style:css>
			...
			*.tei.choice>*.tei.corr,*.tei.choice>*.tei.reg{ Display: Ruby-Text; Font-Size: Smaller; Color: Var(--EditText); Text-Decoration: None }
	...
	<template match="tei:add">
		...
		<style:css>
			*.tei.add{ Display: Inline; Color: Var(--EditText); White-Space: NoWrap; Text-Decoration: None }
	...
	<template match="tei:del">
		...
		<style:css>
			...
			*.tei.del::before{ Color: Var(--EditText); Font-Variant-Caps: Normal; Content: "⸠" }
			*.tei.del::after{ Color: Var(--EditText); Font-Variant-Caps: Normal; Content: "⸡" }
			*.tei.del[data--t-e-i_evidence=conjecture]::after{ Content: "⸡?" }
			<fallback/>
		</style:css>
	</template>
	<template match="tei:unclear">
		...
		<style:css>
			*.tei.unclear{ Display: Inline; Color: Var(--GreyText) }
			*.tei.unclear::before{ Font-Variant-Caps: Normal; Content: "[" }
			*.tei.unclear::after{ Font-Variant-Caps: Normal; Content: "]" }
			*.tei.unclear[data--t-e-i_evidence=conjecture]::after{ Content: "]?" }
			<fallback/>
		</style:css>
	</template>
	<template match="tei:abbr">
		...
		<style:css>
			...
			*.tei.abbr[data--t-e-i_type=acronym]{ Font-Variant-Caps: All-Small-Caps }
			<fallback/>
		</style:css>
	</template>
	...
	<template match="tei:list">
		...
		<style:css>
			...
			*.tei.list[data--t-e-i_type=gloss]{ Columns: 17EM }
			*.tei.list[data--t-e-i_type=gloss]>.tei.head{ Column-Span: All }
	...
	<template match="tei:item">
		...
		<style:css>
			...
			*.tei.item[data--t-e-i_n]::before{ Content: Attr(data--t-e-i_n) ".  " }
			<fallback/>
		</style:css>
	</template>
	...
	<template match="tei:titlePart">
		...
		<style:css>
			...
			*.tei.titlePart[data--t-e-i_type]:Not([data--t-e-i_type=main]){ Font-Size: Inherit; Font-Weight: Inherit; Text-Transform: None }
			*.tei.titlePart[data--t-e-i_type][data--t-e-i_type=sub]:Not(:First-Child){ Margin-Block-Start: .75EM }
			*.tei.titlePart[data--t-e-i_type][data--t-e-i_type=alt]{ Font-Weight: Lighter }
			*.tei.titlePart[data--t-e-i_type][data--t-e-i_type=short]{ Font-Size: Smaller; Text-Transform: Uppercase }
			*.tei.titlePart[data--t-e-i_type][data--t-e-i_type=short]::before{ Font-Variant-Caps: Normal; Content: "(" }
			*.tei.titlePart[data--t-e-i_type][data--t-e-i_type=short]::after{ Font-Variant-Caps: Normal; Content: ")" }
			*.tei.titlePart[data--t-e-i_type][data--t-e-i_type=desc]{ Font-Size: Smaller; Font-Weight: Lighter; Line-Height: 1.5 }
			<fallback/>
		</style:css>
	</template>
	...
	<template match="tei:language">
		...
		<style:css>
			...
			*.tei.language>small,*.tei.language>s{ Color: Var(--GreyText); Font-Size: Inherit }
